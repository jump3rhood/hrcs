...
export default function EmployerJobFormPage() {
  ...
  const addSkill = () => {
    ...
    setSkills((prev) => [
      ...prev.filter((s) => s.skillName !== newSkill.trim()),
      { skillName: newSkill.trim(), required: newRequired },
    ])
    setNewSkill('')
  }
  ...
  return (
    <div className='max-w-2xl mx-auto'>
      <Card>
        <CardHeader>
          <CardTitle>{isEdit ? 'Edit Job' : 'Post a New Job'}</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div>
                ...
                <Select
                  value={watch('jobType')}
                  onValueChange={(v) =>
                    setValue('jobType', v as FormData['jobType'])
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setValue('workMode', v as FormData['workMode'])
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div>
              ...
              <div className='flex gap-2 items-center'>
                ...
                />
                <Select
                  value={newRequired ? 'required' : 'preferred'}
                  onValueChange={(v) => setNewRequired(v === 'required')}
                >
