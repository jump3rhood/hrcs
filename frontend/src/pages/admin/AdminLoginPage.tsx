  ...
  return (
    <div className="w-screen relative left-1/2 -translate-x-1/2 -my-6">
      <div className="min-h-[calc(100vh-57px)] flex flex-col lg:flex-row">
        {/* Hero panel */}
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative bg-[hsl(217,71%,15%)] flex-col items-center justify-center p-12 gap-6">
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-10 lg:py-12 lg:px-12 bg-background">
          <div className="w-full max-w-sm space-y-6">
            <div className="flex items-center gap-3">
              <div className="rounded-lg bg-[hsl(217,71%,15%)] p-2">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <Button type="submit" className="w-full bg-[hsl(217,71%,25%)] hover:bg-[hsl(217,71%,20%)]" disabled={isSubmitting}>
            ...
            <p className="text-sm text-center text-muted-foreground">
              Not an admin?{' '}
              <Link to="/login" className="text-[hsl(214,80%,52%)] underline hover:text-primary">
                Return to login
              </Link>
            </p>
